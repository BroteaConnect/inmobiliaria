...
// Exported because campanas.lib.mjs builds Telegram text too: a campaign name
// comes from a human typing into PocketBase Admin, and it must be escaped and
// capped exactly like a lead's name is.
